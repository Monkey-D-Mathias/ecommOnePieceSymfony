 ...
 */
final class Version20240516142324 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_D34A04AD93CB796C ON product');
        $this->addSql('ALTER TABLE product DROP file_id');
    }
}
